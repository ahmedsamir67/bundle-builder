...
Use the rules outlined in our typescript schema (`schemas/schema.d.ts`, if present in this repo) to determine the appropriate key structure for schema translations.
