...
`.cursor/skills/`, `.cursor/agents/`, `.cursor/workflows/` and
`.cursor/references/` are **generated** by `.claude/scripts/sync-ai-config.sh`.
Edit the `.claude/` copy and run the script; never edit under `.cursor/`.
